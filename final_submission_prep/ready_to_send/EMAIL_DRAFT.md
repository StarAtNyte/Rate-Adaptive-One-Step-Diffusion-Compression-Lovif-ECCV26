...
Dear LoViF 2026 AIGC Image Compression Challenge Organizers,

Please find below the final-test submission information for Team ZeroR.
...
Team leader email: khanalnitij20@gmail.com
...
LoViF 2026 Codabench registration:

- Team name: ZeroR
- Username: nitizkhanal
...
- ZeroR_LoViF2026_AIGC_Factsheet.pdf
- ZeroR_LoViF2026_AIGC_Factsheet_Source.zip

The final result archive was generated using the codec and pretrained model checkpoints submitted during the Code Submission Phase. No decoder model updates, retraining, code modifications, or online/test-time model fine-tuning were performed after that phase.

Thank you for organizing the challenge. I would be happy to provide any additional reproducibility information required for verification.
...
Alternative: 077bel025.nitiz@pcampus.edu.np
