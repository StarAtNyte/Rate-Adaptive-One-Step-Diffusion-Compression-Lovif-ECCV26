...
class DINOv3(torch.nn.Module):
    ...
    def __init__(self, cv_type='adv'):
        ...
        ### If hitting errors, please refer to the official instructions to load dinov3 checkpoints
        ### https://github.com/facebookresearch/dinov3
        self.model = torch.hub.load('facebookresearch/dinov3', 'dinov3_vitb16')
        # self.model = torch.hub.load('<LOCAL_PATH>/dinov3-main', 'dinov3_vitb16', source='local')
