...
void RansEncoder::encode_with_z4y_indexes(const py::array_t<int16_t> &z_symbols,
                                          const py::array_t<int16_t> &z_indexes,
                                          const int z_cdf_group_index,
                                          const py::array_t<int16_t> &y_symbols_0,
                                          const py::array_t<int16_t> &y_indexes_0,
                                          const py::array_t<int16_t> &y_symbols_1,
                                          const py::array_t<int16_t> &y_indexes_1,
                                          const py::array_t<int16_t> &y_symbols_2,
                                          const py::array_t<int16_t> &y_indexes_2,
                                          const py::array_t<int16_t> &y_symbols_3,
                                          const py::array_t<int16_t> &y_indexes_3,
                                          const int y_cdf_group_index) {
    // Call the existing encode_with_indexes
    this->encode_with_indexes(z_symbols, z_indexes, z_cdf_group_index);
    this->encode_with_indexes(y_symbols_0, y_indexes_0, y_cdf_group_index);
    this->encode_with_indexes(y_symbols_1, y_indexes_1, y_cdf_group_index);
    this->encode_with_indexes(y_symbols_2, y_indexes_2, y_cdf_group_index);
    this->encode_with_indexes(y_symbols_3, y_indexes_3, y_cdf_group_index);
}

int RansEncoder::add_cdf(const py::array_t<int32_t> &cdfs,
...
int RansDecoder::add_cdf(const py::array_t<int32_t> &cdfs,
                         const py::array_t<int32_t> &cdfs_sizes,
                         const py::array_t<int32_t> &offsets) {
  py::buffer_info cdfs_sizes_buf = cdfs_sizes.request();
  py::buffer_info offsets_buf = offsets.request();
...
PYBIND11_MODULE(MLCodec_rans, m) {
  ...
  py::class_<RansEncoder>(m, "RansEncoder")
      ...
      .def("encode_with_z4y_indexes", &RansEncoder::encode_with_z4y_indexes)
