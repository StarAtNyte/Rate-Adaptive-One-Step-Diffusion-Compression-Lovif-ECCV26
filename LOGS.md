...
Raw 4-ckpt knapsack: 30.84 board est (vs v10's dev-only 31.32 using unshippable 15-ckpt mix). Re-running full TTO (100 imgs, not just 52) + enhancer stacking on this restricted, shippable set — E35 in progress.
