...
| E44 | 07-11 | Complete final remix (all TTO variants × both enhancers × 4 raw+enhanced) → **v14, submission_v14_shippable.zip** | local 111.3774 @ w-bpp 0.0249 | board est **31.3774**. Gap to UnoChen: **0.933** |
| E45 | 07-11 | 16-block (2x capacity) enhancer trained on matched distribution, 18k steps — tested early (4k steps, not yet comparable) | in progress | testing if capacity was ever the bottleneck |
